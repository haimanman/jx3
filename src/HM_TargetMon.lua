...
HM_TargetMon.tBuffList2 = {
	{
		...
		szType = _L["Silence"],	-- 2
		tName = {
			_b(445)--[[抢珠式]], _b(726)--[[剑飞惊天]], _b(692)--[[沉默]], _b(712)--[[兰摧玉折]],	-- 兰摧玉折2：712
		...
		tName = {
			...
			_b(4421)--[[灵辉]], _b(4468)--[[超然]], _b(6373)--[[出渊]], _b(6163)--[[飞将]], _b(6314)--[[零落]], _b(6292)--[[吞日月]],
			_b(6247)--[[迷心蛊]], _b(6192)--[[菩提身]], _b(6131)--[[青阳]], _b(5995)--[[笑醉狂]],
			_b(6015)--[[龙跃于渊]], _b(6369)--[[酒中仙]]
		},
	}, {
		szType = _L["Halt"],	-- 4
		tName = {
...
_HM_TargetMon.OnSkillCast = function(dwCaster, dwSkillID, dwLevel, szEvent)
	...
	HM.Debug2("#" .. dwCaster .. "#" .. szEvent .. " (" .. szName .. "#" .. dwSkillID .. ", Lv" .. dwLevel .. ")")
	-- check reset
