...
HM_TargetMon.tBuffList2 = {
	{
		...
		szType = _L["Silence"],	-- 2
		tName = {
			_b(534)--[[止息]], _b(445)--[[抢珠式]], _b(726)--[[剑飞惊天]], _b(692)--[[沉默]], _b(734)--[[悬钟]],
			_b(712)--[[兰摧玉折]],	-- 兰摧玉折2：712
			_b(690)--[[剑心通明]], _b(2182)--[[八卦洞玄]], _b(2838)--[[剑破虚空]], _b(3227)--[[梅花针]], _b(2807)--[[凄切]],
			_b(2490)--[[蟾啸迷心]], _b(4053)--[[怖畏暗刑]]
		},
	}, {
		...
		tName = {
			...
			_b(1686)--[[梦泉虎跑]], _b(2840)--[[蛊虫狂暴]], _b(2544)--[[风蜈献祭]], _b(3822)--[[碧蝶献祭]],
			_b(4421)--[[灵辉]], _b(4468)--[[超然]], _b(6163)--[[飞将]], _b(6314)--[[零落]], _b(6292)--[[吞日月]],
			_b(6247)--[[迷心蛊]], _b(6192)--[[菩提身]], _b(6131)--[[青阳]], _b(5995)--[[笑醉狂]],
			_b(6015)--[[龙跃于渊]]
		},
	}, {
		szType = _L["Halt"],	-- 4
		tName = {
			...
			_b(6128)--[[虎贲]], _b(6107)--[[弩击]], _b(5876)--[[善护]]
		},
	}, {
		szType = _L["Entrap"],	-- 5
		tName = {
			_b(1937)--[[三才化生]], _b(679)--[[影痕]], _b(706)--[[止水]], _b(4038)--[[锁足]], _b(2289)--[[五方行尽]],
			_b(2492)--[[百足迷心]], _b(2504)--[[影滞]], _b(2547)--[[天蛛献祭]], _b(1931)--[[吐故纳新]], _b(6364)--[[滞]],
			_b(5809)--[[太乙]], _b(5764)--[[百足]], _b(5694)--[[太阴指]],
		},
	}, {
		szType = _L["Freeze"],	-- 6
		tName = {
		...
		tName = {
			...
			_b(3468)--[[心无旁骛]], _b(3859)--[[香疏影]], _b(2726)--[[乱洒]], _b(5994)--[[酒中仙]]
		},
	}, {
		...
		tName = {
			...
			_b(1802)--[[御天]], _b(2542)--[[玉蟾献祭]], _b(684)--[[天地低昂]], _b(4439)--[[贪魔体]], _b(6315)--[[零落]],
			_b(6240)--[[玄水蛊]], _b(5996)--[[笑醉狂]], _b(5810)--[[脑户]], _b(6200)--[[龙啸九天]]
		},
	}, {
		szType = _L["Dodge"],	-- 9
		tName = {
			_b(677)--[[鹊踏枝]], _b(3214)--[[惊鸿游龙]], _b(2065)--[[云栖松]], _b(5668)--[[风吹荷]]
		},
	}, {
