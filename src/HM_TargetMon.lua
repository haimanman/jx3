...
HM_TargetMon.tBuffList = {
	{
		...
		tName = { _b(377)--[[镇山河]], _b(961)--[[太虚]], _b(772)--[[回神]], _b(3425)--[[鬼斧神工]], _b(360)--[[御]] },
	}, {
		szType = _L["Silence"],	-- 2
		tName = {
			_b(534)--[[止息]], _b(445)--[[抢珠式]], _b(726)--[[剑飞惊天]], _b(692)--[[沉默]], _b(734)--[[悬钟]], _b(712)--[[兰摧玉折]],	-- 兰摧玉折2：712
			_b(690)--[[剑心通明]], _b(2182)--[[八卦洞玄]], _b(2838)--[[剑破虚空]], _b(3227)--[[梅花针]], _b(2807)--[[凄切]], _b(2490)--[[蟾啸迷心]],
			_b(4053)--[[怖畏暗刑]],
		},
	}, {
		...
		tName = {
			...
			_b(1686)--[[梦泉虎跑]], _b(2840)--[[蛊虫狂暴]], _b(2544)--[[风蜈献祭]], _b(730)--[[风府]], _b(3822)--[[碧蝶献祭]],
			_b(4421)--[[灵辉]], _b(4468)--[[超然]],
		},
	}, {
		szType = _L["Halt"],	-- 4
		tName = {
			...
			_b(2489)--[[蝎心迷心]], _b(2780)--[[剑冲阴阳]], _b(3223)--[[雷震子]], _b(3224)--[[迷神钉]], _b(727)--[[崩]], _b(1938)--[[峰插云景]],
			_b(4029)--[[日劫]], _b(4871)--[[无明魂锁]], _b(4875)--[[镇魔]],
		},
	}, {
		szType = _L["Entrap"],	-- 5
		tName = {
			_b(1937)--[[三才化生]], _b(679)--[[影痕]], _b(706)--[[止水]], _b(4038)--[[锁足]], _b(2289)--[[五方行尽]],
			_b(2492)--[[百足迷心]], _b(2504)--[[影滞]], _b(2547)--[[天蛛献祭]], _b(1931)--[[吐故纳新]],
		},
	}, {
		szType = _L["Freeze"],	-- 6
		tName = {
			_b(678)--[[傍花随柳]], _b(686)--[[帝骖龙翔]], _b(554)--[[大道无术]], _b(556)--[[七星拱瑞]], _b(675)--[[芙蓉并蒂]], _b(737)--[[完骨]],
			_b(998)--[[太阴指]], _b(1229)--[[破势]], _b(1247)--[[同归]], _b(4451)--[[定身]], _b(1857)--[[松涛]], _b(1936)--[[绛唇珠袖]], _b(2555)--[[丝牵]],
		},
	}, {
		...
		tName = { _b(374)--[[生太极]], _b(1903)--[[啸日]] },	-- 生太极2：374
	}, {
		szType = _L["Reduce-heal"],	-- 11
		tName = { _b(2774)--[[霹雳]], _b(3195)--[[穿心弩]], _b(3538)--[[穿心]], _b(574)--[[无相]], _b(576)--[[恒河劫沙]], _b(2496)--[[百足枯残]], _b(2502)--[[蝎蛰]], _b(4030)--[[月劫]]  },
	}, {
		szType = _L["Slower"],	-- 12
		tName = {
			_b(4928)--[[减速]], _b(549)--[[穿]], _b(450)--[[玄一]], _b(523)--[[步迟]], _b(2274)--[[缠足]], _b(560)--[[生太极]], _b(563)--[[抱残式]],
			_b(584)--[[少阳指]], _b(733)--[[太乙]], _b(1553)--[[剑主天地]], _b(1720)--[[惊涛]], _b(2297)--[[千丝]], _b(2839)--[[玳弦]], _b(3226)--[[毒蒺藜]], _b(4054)--[[业海罪缚]] },
	}, {
		szType = _L["Others"],	-- 13
		tName = { _b(535)--[[半步颠]], _b(678)--[[傍花随柳]], _b(3929)--[[龙魂]], _b(198)--[[徐如林]], _b(203)--[[啸如虎]], _b(3858)--[[声趣]], _b(994)--[[倒地]], _b(3399)--[[无声]], _b(3276)--[[追命无声]], _b(4028)--[[圣月佑]] },
	}
}
...
HM.RegisterCustomUpdater(function()
	...
	table.insert(HM_TargetMon.tBuffList[3].tName, _b(4468)--[[超然]])
