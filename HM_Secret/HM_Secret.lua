...
_HM_Secret.PS.OnPanelActive = function(frame)
	...
	-- Tips
	ui:Append("Text", { x = 0, y = 0 + 164, txt = "海鳗秘密", font = 27 })
	nX = ui:Append("Text", { x = 0, y = 0 + 192, txt = "树洞、吐槽、趣事分享，关注微信公众号【" }):Pos_()
	nX = ui:Append("Text", { x = nX, y = 0 + 192, txt = "海鳗插件", font = 51 }):Hover(function()
		local x, y = Cursor.GetPos()
		OutputTip(GetFormatImage("interface\\HM\\HM_0Base\\image.UiTex", 2, 148, 148), 200, {x, y, 0, 0})
	end, function()
		HideTip()
	end):Pos_()
	ui:Append("Text", { x = nX, y = 0 + 192, txt = "】后访问。" })
	...
	-- verify
	ui:Append("Text", { x = 0, y = 214 - 214, txt = "海鳗插件认证", font = 27 })
