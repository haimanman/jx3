...
_HM_TargetMon.tBuffList4 = {
	{
		...
		tName = {
			...
			_b(2755)--[[±±¶·]], _b(1902)--[[Î£Â¥]], _b(2877)--[[ÈÕÓ°]], _b(4438)--[[·üÒ¹¡¤ÔÎ]], _b(8257)--[[²½ÁÙ]],
			_b(8329)--[[¶Ü³å]], _b(8455)--[[¶ÜÒã]],
		},
	}, {
		szType = _L["Entrap"],	-- 5
		tName = {
			...
			_b(3359)--[[Ìú×¦]], _b(8251)--[[ÂäÑã]], _b(8327)--[[¶Ï½î]],
		},
	}, {
		szType = _L["Freeze"],	-- 6
		tName = {
		...
		tName = {
			...
			_b(6262)--[[½ðÎÝ]], _b(2489)--[[µûÏ·Ë®]], _b(3315)--[[»¤Ìå]], _b(8279)--[[¶Ü±Ú]], _b(8300)--[[¶ÜÇ½]],
			_b(8427)--[[ÈÙ»Ô]],
		},
	}, {
		szType = _L["Dodge"],	-- 9
		...
		tName = {
			...
			_b(3466)--[[ë¾×ã]], _b(4435)--[[·üÒ¹¡¤»º]], _b(8299)--[[¶ÜÇ½]], _b(8398)--[[¾íÔÆ]],
		},
	}, {
		szType = _L["Others"],	-- 13
		tName = {
		...
		tName = {
			...
			_b(1939)--[[ÔÆ¾°]], _b(6074)--[[¶ñ¹·À¹Â·]], _b(4497)--[[»ÃÏà]], _b(535)--[[°ë²½µß]],
		},
	}
}
...
_HM_TargetMon.tFixedBuffEx = {
	...
	[_L("Uncontrollable_%s", _b(8449)--[[ÑªÅ­]])] = 8449,
