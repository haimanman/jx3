...
_HM_TargetMon.tBuffList4 = {
	{
		...
		tName = {
			...
			_b(2492)--[[°Ù×ãÃÔÐÄ]], _b(2547)--[[ÌìÖëÏ×¼À]], _b(1931)--[[ÍÂ¹ÊÄÉÐÂ]], _b(6364)--[[ÖÍ]],
			_b(5809)--[[Ì«ÒÒ]], _b(5764)--[[°Ù×ã]], _b(5694)--[[Ì«ÒõÖ¸]], _b(5793)--[[Ëé±ù]],
		},
	}, {
		szType = _L["Freeze"],	-- 6
		tName = {
		...
		tName = {
			...
			_b(6262)--[[½ðÎÝ]], _b(2489)--[[µûÏ·Ë®]], _b(3315)--[[»¤Ìå]],
		},
	}, {
		szType = _L["Dodge"],	-- 9
		tName = {
		...
		tName = {
			...
			_b(2315)--[[Å®æ´²¹Ìì]], _b(2795)--[[ÂÞºº½ðÉí]], _b(2778)--[[Ô¨]], _b(3215)--[[¾£Ìì¼¬µØ]],
			_b(6256)--[[ÎÖÍÁ]], _b(2542)--[[Óñó¸Ï×¼À]],  _b(2920)--[[¼±Çú]], _b(748)--[[µþÈÐ]],
		},
	}, {
...
-- 1£ºÌì²ß£¬2£ºÍò»¨£¬3£º´¿Ñô£¬4£ºÆßÐã£¬5£ºÉÙÁÖ£¬6£º²Ø½££¬7£ºØ¤°ï£¬8£ºÃ÷½Ì£¬9£ºÎå¶¾£¬10£ºÌÆÃÅ
-- 1£ºÉÙÁÖ£¬2£ºÍò»¨£¬3£ºÌì²ß£¬4£º´¿Ñô£¬5£ºÆßÐã£¬6£ºÎå¶¾£¬7£ºÌÆÃÅ£¬8£º²Ø½££¬9:Ø¤°ï£¬10£ºÃ÷½Ì
